...
{
    public class GradeParamConfiguration : IEntityTypeConfiguration<GradeParam>
    {
        public void Configure(EntityTypeBuilder<GradeParam> builder)
        {
            builder.ToTable(nameof(GradeParam));
